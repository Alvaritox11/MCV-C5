...
class VizWizDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        labels = self.tokenizer(text=raw_caption, padding="max_length", max_length=self.tokenizer.model_max_length, truncation=True, return_tensors="pt").input_ids.squeeze(0)
...
def get_dataloaders(cfg):
    ...
    tokenizer = AutoTokenizer.from_pretrained(cfg.get("model_name", "nlpconnect/vit-gpt2-image-captioning"))
